...
function FinanceForm({
  ...
  useEffect(() => {
      setFormData({
        ...
        price: typeof selectedFinanceData?.price === 'number' ? selectedFinanceData?.price / 100 : 0,
  ...
  return (
    <div className="drawer drawer-end z-2">
      ...
      <div className="drawer-side">
        ...
        <div className="w-full max-w-sm sm:max-w-md md:max-w-lg h-full bg-white p-6 overflow-y-auto shadow-xl">

          {/* Drawer Header */}
          <h4 className="text-2xl font-bold text-center mt-4">{selectedFinanceData?.id ? 'Update Finance' : 'Add Finance'}</h4>
          <form method="dialog">
            <button 
